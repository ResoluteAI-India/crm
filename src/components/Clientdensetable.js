...
const displayClient = (id,name,address,spoc,number) =>{
  ...
  <div>
    ...
    {/* <Box height={25} /> */}
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField style={{marginTop:"5%"}}{...params} size="small" label="Search Clients" />
              )}
            />
    ...
    <Button variant="contained" color="error" onClick={handleOpen} style={{backgroundColor:"red",marginLeft:"350px" ,width:"22%",height:"40px",marginTop:"1%"}}>
    <AddIcon/>Add Client
