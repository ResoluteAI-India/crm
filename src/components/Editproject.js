...
export default function Editproject({closeEvent,formid}) {
  ...
  const[id,setId] = useState("")
    ...
    let stringstartdate = JSON.stringify(startdate);

    const[enddate,setEnddate] = useState(dayjs(date))
    let stringenddate = JSON.stringify(enddate);
...
const pac = jac.map(client => client.name)
  ...
  return (
    ...
    <Grid container xs={12}>
     <TextField id="outlined-basic" value={pname} onChange={handlePname} style={{marginBottom:"3px"}} label="Name" variant="outlined" size='small' sx={{minWidth:"100%"}} />
    ...
    <Grid container xs={12}>
     {/* <TextField id="outlined-basic" value={cname} onChange={handleCname} style={{marginBottom:"3px"}} label="Address" variant="outlined" size='small' sx={{minWidth:"100%"}} /> */}
     <Autocomplete
     id="combo-box-demo"
      options={pac}
      sx={{ width: 400 }}
      renderInput={(params) => <TextField {...params} label="Client Name" />}
      onChange={(event,value)=>setCname(value)} value={cname}
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     {/* <TextField id="outlined-basic" value={startdate} onChange={handleStartdate} style={{marginBottom:"3px"}} label="Spoc" variant="outlined" size='small' sx={{minWidth:"100%"}} /> */}
    </Grid>
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
     ...
     {/* <TextField id="outlined-basic" value={enddate} onChange={handleEnddate} style={{marginBottom:"3px"}} label="Numbers" variant="outlined" size='small' sx={{minWidth:"100%"}} /> */}
    </Grid>
