...
const createClient = async() =>{
  await addDoc(empCollectionRef,{
    ...
    spoc:spocfield
    // spoc_name:spocfield.full_name,
    // spoc_designation:spocfield.designation,
    // spoc_number:spocfield.spoc_number,
    // spoc_email:spocfield.spoc_email
  ...
  return (
    ...
    >
      ...
      <TextField id="outlined-basic"  required label="Address" variant="outlined" value={address} onChange={handleAddress} sx={{'& > :not(style)': { m: 2, width: '110ch',marginTop:"-10px",marginLeft:"-2px" },}} />
      <TextField id="outlined-basic"  required label="Comment" variant="outlined" value={comment} onChange={handleComment} sx={{'& > :not(style)': { m: 2, width: '111ch',height:"13ch", marginTop:"70px",marginLeft:"-510px"},}}/>
...
/>
    ...
    >
      ...
      <TextField id="outlined-basic"  required label="Bank Name" value={bank_name} onChange={handleBank_name} variant="outlined"  sx={{'& > :not(style)': { m: 2, width: '110ch',marginTop:"-10px",marginLeft:"-10px" },}} />
      <TextField id="outlined-basic"  required label="Account Holder Name" value={account_holder_name} onChange={handleAccount_holder_name} variant="outlined" sx={{'& > :not(style)': { m: 2, width: '53ch',marginLeft:"-515px",marginTop:"70px" },}}  />
      <TextField id="outlined-basic"  required label="Account Number " value={account_number} onChange={handleAccount_number} variant="outlined" sx={{'& > :not(style)': { m: 2, width: '53ch',marginTop:"-100px",marginLeft:"495px" },}} />
      <TextField id="outlined-basic"  required label="Branch  Name" value={branch_name} onChange={handleBranch_name} variant="outlined" sx={{'& > :not(style)': { m: 2, width: '53ch',marginLeft:"-515px",marginTop:"-20px" },}}  />
      <TextField id="outlined-basic"  required label="IFSC Code " value={ifsc_code} onChange={handleIfsc_code} variant="outlined" sx={{'& > :not(style)': { m: 2, width: '53ch',marginTop:"-102px",marginLeft:"246px" },}} />   
    </Box>
      </CardContent>
    </Card>
