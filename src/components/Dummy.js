...
const columns = [
  ...
  return (
    ...
    <Box sx={{ height: 400, width: '90%',marginTop:"1%" }}>
    <Box height={25} />
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField style={{marginTop:"4%"}}{...params} size="small" label="Search Clients" />
              )}
            />
    ...
    <Button variant="contained" color="error" onClick={handleOpen} style={{backgroundColor:"red",marginLeft:"300px" ,width:"150px",height:"40px",marginTop:"1%"}}>
    <AddIcon/>Add Client
