...
export default function Projectdensetable() {
  ...
  const deleteApi = async (id) => {
    const userDoc = doc(firebase.db, "projects",id);
  ...
  const editProject = (id,pname,cname,startdate,enddate) =>{
  const data = {
    id:id,
    pname:pname,
    cname:cname,
...
const displayProject = (id,pname,cname,startdate,enddate) =>{
  const ddata = {
    id:id,
    pname:pname,
    cname:cname,
...
const filterData = (v) => {
  ...
  <div>
    ...
    >
      <Box sx={style}>
       <Editproject closeEvent={handleEditClose} formid={formid}/>
      </Box>
    </Modal>
  </div> 
    ...
    {/* <Box height={25} /> */}
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} size="small" label="Search Project" style={{marginTop:"5%"}}/>
              )}
            />
                ...
                return (
                  ...
                  >
                    ...
                    <EditIcon
                              ...
                              onClick={() => editProject(row.id,row.pname,row.cname,row.startdate,row.enddate)}
                            />
                          <DeleteIcon
                              style={{
                                fontSize: "20px",
                            ...
                            />
                              ...
                              className="cursor-pointer"
                              onClick={() => displayProject(row.id,row.pname,row.cname,row.startdate,row.enddate)}
                            />
                    </TableCell>
                   </TableRow>
                );
